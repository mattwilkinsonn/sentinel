...
const DEMO_CHARACTERS: &[DemoCharacter] = &[
    DemoCharacter { id: 88401, name: "Vex Nightburn", kills: 11, deaths: 3, bounties: 2, recent_24h: 4, systems: 6, system_name: "J-1042" },
    DemoCharacter { id: 55102, name: "Kira Ashfall", kills: 8, deaths: 5, bounties: 1, recent_24h: 3, systems: 8, system_name: "K-9731" },
    DemoCharacter { id: 77320, name: "Dread Solaris", kills: 7, deaths: 1, bounties: 1, recent_24h: 2, systems: 3, system_name: "X-4419" },
    DemoCharacter { id: 12055, name: "Mira Voidwalker", kills: 5, deaths: 6, bounties: 1, recent_24h: 1, systems: 12, system_name: "N-8820" },
    DemoCharacter { id: 33781, name: "Talon Drift", kills: 4, deaths: 7, bounties: 0, recent_24h: 1, systems: 5, system_name: "J-1042" },
    DemoCharacter { id: 90042, name: "Zero Pragma", kills: 14, deaths: 2, bounties: 3, recent_24h: 6, systems: 2, system_name: "Z-0091" },
    DemoCharacter { id: 41199, name: "Sable Ren", kills: 3, deaths: 3, bounties: 0, recent_24h: 0, systems: 7, system_name: "H-5534" },
    DemoCharacter { id: 62830, name: "Ash Meridian", kills: 1, deaths: 8, bounties: 0, recent_24h: 0, systems: 4, system_name: "K-9731" },
    DemoCharacter { id: 15467, name: "Nyx Corvane", kills: 6, deaths: 3, bounties: 1, recent_24h: 2, systems: 5, system_name: "X-4419" },
    DemoCharacter { id: 28903, name: "Jace Holloway", kills: 3, deaths: 4, bounties: 0, recent_24h: 1, systems: 9, system_name: "N-8820" },
    DemoCharacter { id: 50710, name: "Ember Kael", kills: 1, deaths: 0, bounties: 0, recent_24h: 0, systems: 2, system_name: "J-1042" },
    DemoCharacter { id: 83216, name: "Wraith Decimax", kills: 9, deaths: 2, bounties: 2, recent_24h: 3, systems: 4, system_name: "Z-0091" },
    DemoCharacter { id: 19544, name: "Lux Tenebris", kills: 0, deaths: 3, bounties: 0, recent_24h: 0, systems: 3, system_name: "H-5534" },
    DemoCharacter { id: 47688, name: "Rook Vantage", kills: 4, deaths: 5, bounties: 1, recent_24h: 1, systems: 6, system_name: "X-4419" },
    DemoCharacter { id: 71035, name: "Lyra Ironveil", kills: 7, deaths: 1, bounties: 1, recent_24h: 2, systems: 4, system_name: "K-9731" },
];

const SYSTEMS: &[&str] = &["J-1042", "K-9731", "X-4419", "N-8820", "Z-0091", "H-5534", "Q-2281", "R-0099", "W-7714"];

pub async fn seed_demo_data(state: Arc<RwLock<AppState>>) {
    tracing::info!("DEMO MODE — seeding {} threat profiles", DEMO_CHARACTERS.len());
    ...
    for i in 0..10 {
        ...
        let (event_type, data) = if event_roll < 40 {
            ...
            let target = &DEMO_CHARACTERS[rng.random_range(0..char_count)];
            ("bounty_stacked", serde_json::json!({
            ...
            let target = &DEMO_CHARACTERS[rng.random_range(0..char_count)];
            ("bounty_claimed", serde_json::json!({
                "hunter_id": hunter.id,
                "target_item_id": target.id,
    ...
    s.demo.recent_events.make_contiguous().sort_by(|a, b| b.timestamp_ms.cmp(&a.timestamp_ms));

    tracing::info!("Demo data seeded: {} profiles, {} events", s.demo.profiles.len(), s.demo.recent_events.len());
}
...
pub async fn demo_event_loop(state: Arc<RwLock<AppState>>) {
    ...
    loop {
        ...
        let (event_type, data) = if event_roll < 35 {
            ...
            ("bounty_removed", serde_json::json!({
                "poster_id": poster.id,
                "target_item_id": target.id,
            }))
            ...
            let new_score = {
                ...
                s.demo.profiles.get(&c.id).map(|p| p.threat_score).unwrap_or(0)
            };

            ("score_change", serde_json::json!({
                "character_id": c.id,
                "new_score": new_score,
            ...
            let names = ["Ghost Sigma", "Wreck Auton", "Null Vector", "Shade Proxy", "Flux Daemon",
                         "Echo Vanta", "Drift Cipher", "Blaze Axiom", "Void Syntex", "Hex Remnant"];
