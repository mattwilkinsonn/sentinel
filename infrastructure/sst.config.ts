...
export default $config({
  ...
  async run() {
    ...
    // Log group name is auto-generated by SST from cluster/service physical names.
    const backendLogGroupName = $interpolate`/sst/cluster/${cluster.nodes.cluster.name}/${backend.nodes.service.name}/SentinelBackend`;
